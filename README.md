[![CircleCI](https://dl.circleci.com/status-badge/img/gh/giantswarm/headlamp/tree/main.svg?style=svg)](https://dl.circleci.com/status-badge/redirect/gh/giantswarm/headlamp/tree/main)

[Read me after cloning this template (GS staff only)](https://handbook.giantswarm.io/docs/dev-and-releng/app-developer-processes/adding_app_to_appcatalog/)

# headlamp chart

Giant Swarm offers a headlamp App which can be installed in workload clusters.
Here, we define the headlamp chart with its templates and default configuration.
